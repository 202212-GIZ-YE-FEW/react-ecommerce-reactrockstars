  ...
  return (
    <nav className="header px-4">
      ...
      <div className="header-icons">
        ...
        <Button onClick={toggleDrawer('right', true)} className="relative">
          <span className='bg-[red] rounded-full text-xs px-1 absolute text-white'>{products.length>0 ? products.length : ''}</span>
