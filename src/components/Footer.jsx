          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-2">
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className="flex flex-col items-start">
                ...
                <dd className="mt-2 leading-7 text-gray-400 font-medium text-lg">
                  <ul>
                    <li>
                      <Link href="/about" className="text-gray-400 hover:text-gray-600">
                        About Us
                      </Link>
                    </li>
                    <li>
              ...
              <div className="flex flex-col items-start">
                ...
                <dt className="mt-4 font-semibold text-white">Categories</dt>
                <div className="grid grid-cols-2 gap-4">
                  {categories.map((category) => (
                    <dd key={category.id} className="mt-2 leading-7 text-gray-400">
                      <Link href={`/category/${category.id}`} as={`/category/${category.id}`} className="text-gray-400 hover:text-gray-600 font-medium text-lg">
                        {category.name}
                      </Link>
                    </dd>
                  ))}
